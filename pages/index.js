...
export default function Home() {
  return (
    <>
      ...
      <div class="relative bg-primary bg-cover bg-center bg-no-repeat py-16 bg-blend-multiply lg:py-24" style={{ backgroundImage: "url(https://atom.redpixelthemes.com/assets/img/bg-cta.jpg)" }}>
        <div class="container relative z-30">
          ...
          <form class="mt-6 flex flex-col justify-center sm:flex-row">
            <input class="w-full rounded px-4 py-3 font-body text-black sm:w-2/5 sm:py-4 lg:w-1/3" type="text" id="email" placeholder="Give me your Email" />
            <button class="mt-2 rounded bg-yellow-500 px-8 py-3 font-body text-base font-bold uppercase text-primary transition-colors hover:bg-[rgba(65,47,144,.93)] hover:text-white focus:border-transparent focus:outline-none focus:ring focus:ring-yellow sm:ml-2 sm:mt-0 sm:py-4 md:text-lg">
              Join the club
            </button>
          </form>
        </div>
      </div>
      <div class="bg-[rgba(65,47,144,.93)]">
        <div class="container flex flex-col justify-between p-6 sm:flex-row">
